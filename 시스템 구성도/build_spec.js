...
const children = [
  ...
  table(['서비스', '용도', '엔드포인트 · 호출 방식', 'config.js 항목', '호출 위치', '제약'], [
    ...
    ['한국환경공단 에어코리아 (공공데이터포털)', '시도별 PM10 · PM2.5 · 등급', 'apis.data.go.kr/B552584/ArpltnInfrInqireSvc/getCtprvnRltmMesureDnsty', 'dataGoKr', '장소 상세 (6개 화면)', '활용신청 필요 · 30분 캐시'],
