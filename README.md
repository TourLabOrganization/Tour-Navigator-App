...
| 투어 플래너 | `Tour Planner.dc.html` | 전 테마 장소 통합, 도시 클러스터, 코스 계산, 광역교통 2단계 선택 · 이동 체인 · 시각표, 내 플랜 저장 |
...
- **교통** — KTX·SRT·고속버스·렌터카·항공(제주)·카페리·도시철도. 광역교통 → 현지 이동 2단계 선택, 출발지 → 환승 관문 → 도착 관문 체인과 시각표, 복수 경로 선택
- **내 플랜** — 코스를 이름 붙여 저장 · 불러오기 · 삭제, 일자별 장소 추가
